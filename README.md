...
**Iowa City • Coralville • North Liberty • Tiffin • Solon • Cedar Rapids • Hiawatha • Marion • and the greater metro corridor between them**

This project exists to say—quickly and clearly:
...
- Clear explanations of **what peer support is (and is not)**
- A **local-first resource directory** for Johnson & Linn Counties
- Practical, human **recovery skill-building activities**
- Templates, language, and structures that anyone can reuse, remix, or fork

This is not a startup pitch.  
This is not a walled garden.  
This is a **map left out in the open**.
...
- Built on **trust, dignity, and mutual respect**
- Clear about what peer support does (and doesn't do)

### Scope of Role (Trust is Infrastructure)
...
This clarity protects peers *and* participants.

### Local Resources (Johnson & Linn Counties)
No shame. No jargon. No maze without a legend.

### Recovery as Practice (Not Just Talk)
Recovery sticks when it has texture:
- Mindfulness, medication consistency, journaling
- Movement and walking the Corridor cities
- Learning to trust the bus—one ride at a time
...
At many points in my life, I was "fit" to disappear quietly.  
Instead, I found a path—one that **didn't cut me when I stepped onto it**.

This repo exists so that path doesn't vanish behind me.

**Fork it. Adapt it. Localize it. Print it. Teach from it. Build something kinder with it.**
...
You may:
- Use it, copy it, modify it, distribute it, sell it, teach from it, build on it
- No attribution required
- No permission needed

> **Steal this information and use it to live well. ♾️**
...
- **Add missing resources:** Submit a pull request
- **Improve documentation:** Suggest edits
- **Localize for your area:** Fork and adapt
- **Share your experience:** Help us understand what works

### Accuracy + Kindness > Polish
Contribution guidelines coming soon. For now: if it helps people find support, it belongs here.
